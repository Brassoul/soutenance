        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                        ...
                        <tr>
                            <th scope="row">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset($item->attributes->image) }}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                </div>
                            </th>
                            <td>
                            ...
                            <td>
                                <div class="input-group quantity mt-4" style="width: 100px;">
                                    <div class="input-group-btn">
                                        {{-- <a href="{{ route('Add.quantity',$item->id) }}"></a> --}}
                                        <a  href="{{ route('decrease.quantity',$item->id) }}" class="btn btn-sm btn-minus rounded-circle bg-light border" >
                                        <i class="fa fa-minus"></i>
                                        </a>
                                    </div>
                                    <input type="text" class="form-control form-control-sm text-center border-0" value="{{$item->quantity}}">
                                    <div class="input-group-btn">
                                        <a href="{{ route('Add.quantity',$item->id) }}" class="btn btn-sm btn-plus rounded-circle bg-light border">
                            ...
                            <td>
                                <a  href="{{ route('remove.produit',$item->id) }}" class="btn btn-md rounded-circle bg-light border mt-4" >
                ...
                <div class="mt-5">
                    ...
                    <a href="{{ route('site.shop') }}" class="btn border-secondary rounded-pill px-4 py-3 text-primary"> shop</a>
                </div>
