                ...
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body d-flex align-items-center">
                        <div class="input-group w-75 mx-auto d-flex">
                            <form action="{{ route('site.shop') }}" method="GET" class="input-group w-75 mx-auto d-flex">
                                <input type="search" name="search" class="form-control p-3" placeholder="Rechercher" aria-describedby="search-icon-1">
    ...
    <div class="container py-5">
        ...
        <div class="row g-4">
            <div class="col-lg-12">
                <div class="row g-4">
                    <div class="col-xl-3">
                        <form action="{{ route('site.shop') }}" method="GET" class="input-group w-80 mx-auto d-flex">
                            <input type="search" name="search" class="form-control p-3" placeholder="Rechercher" aria-describedby="search-icon-1">
                            <button type="submit" id="search-icon-1" class="input-group-text p-3"><i class="fa fa-search"></i></button>
                        </form>
                    </div>
                    <div class="col-6"></div>
                    <div class="col-xl-3">
                        <form action="{{ route('site.shop') }}" method="GET" id="sortForm">
                            <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
                                <label for="fruits">Tri par défaut :</label>
                                <select id="fruits" name="sort_by" class="border-0 form-select-sm bg-light me-3" onchange="document.getElementById('sortForm').submit();">
                                    <option value="">Rien</option>
                                    <option value="popularity">Popularité</option>
                                    <option value="average_rating">Avis clients</option>
                ...
                <!-- Affichage des catégories et filtre par prix -->
                <div class="row g-4">
                    <div class="col-lg-3">
                        <div class="row g-4">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <form action="{{ route('site.shop') }}" method="GET">
                                        ...
                                        <input type="range" class="form-range w-100" id="rangeInput" name="price_range" min="0" max="5000" value="0" oninput="amount.value=rangeInput.value">
                                        <output id="amount" name="amount" min-value="0" max-value="5000" for="rangeInput">0</output>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <form action="{{ route('site.shop') }}" method="GET">
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="Categories-1" name="extra_filter" value="organique">
                                            <label for="Categories-1"> Organique</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="Categories-2" name="extra_filter" value="fraiche">
                                            <label for="Categories-2"> Fraîche</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="Categories-3" name="extra_filter" value="sale">
                                            <label for="Categories-3"> Salés</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="Categories-4" name="extra_filter" value="discount">
                                            <label for="Categories-4"> Discount</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="Categories-5" name="extra_filter" value="expired">
                                            <label for="Categories-5"> Expirés</label>
                                        </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-4">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{ asset('storage/' . $item->chemin) }}" class="img-fluid w-100 rounded-top" alt="">
                                        </div>
                                        <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">
                                            {{ $item->cathegorie->cathegorie }}
                                        </div>
